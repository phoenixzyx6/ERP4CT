...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Tyre\R810404.rdlc"  DisplayName="车辆换胎记录表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="select CONVERT(varchar(10),ChangeDate,111) AS ChangeDate ,CarID ,TyreType ,NewTyreID ,ChangeReason ,InstallPlace ,Mileage from TyreChange ORDER BY ChangeDate,CarID ASC"  SelectCommandType="Text" CancelSelectOnNullParameter="False"  >
       </asp:SqlDataSource> 
