<%@ Page Title="交接单" Language="C#" MasterPageFile="~/Reports/QCCReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
        ...
        <LocalReport ReportPath="Reports\QCC\R710802.rdlc"  DisplayName="现场交接单">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_JJB"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
