<%@ Page Title="出厂质量合格证" Language="C#" MasterPageFile="~/Reports/QCCReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase" 
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {           
            ...
            if (Request["uid"] != null)
            {
                ...
                this.tbCommitID.Text = Request["uid"].ToString();
                SetEnterpriseName();
            }
        }
    }
    ...
    {
        if (this.tbCommitID.Text.Length > 0)
        {
            this.ReportViewer1.LocalReport.Refresh();
        }
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
        ...
        委托单号<asp:TextBox ID="tbCommitID" runat="server"></asp:TextBox>
        ...
        <LocalReport ReportPath="Reports\QCC\R710618.rdlc"  DisplayName="出厂质量合格证">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_HGZ"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
                <asp:ControlParameter ControlID="tbCommitID" Name="CommitID" PropertyName="Text" /> 
           </SelectParameters>
       </asp:SqlDataSource>
</asp:Content>
