<%@ Page Title="矿粉试验报表" Language="C#" MasterPageFile="~/Reports/QCCReportsBase.Master"  Inherits="ZLERP.Web.Reports.ReportBase" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
        ...
        <LocalReport ReportPath="Reports\QCC\R710615.rdlc"  DisplayName="矿粉试验报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_AIR2Exam"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
