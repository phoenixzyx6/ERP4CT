<%@ Page Title="生产配合比例通知单(调整后)" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\QCC\R710823.rdlc"  DisplayName="生产配合比例通知单(调整后)">  
            <DataSources>
