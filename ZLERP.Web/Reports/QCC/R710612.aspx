<%@ Page Title="细骨料试验报表" Language="C#" MasterPageFile="~/Reports/QCCReportsBase.Master"  Inherits="ZLERP.Web.Reports.ReportBase" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
        ...
        <LocalReport ReportPath="Reports\QCC\R710612.rdlc"  DisplayName="细骨料试验报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_FAExam"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
