<%@ Page Title="配合比通知单" Language="C#" MasterPageFile="~/Reports/QCCReportsBase.Master"  Inherits="ZLERP.Web.Reports.ReportBase" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
        ...
        交接单号:<asp:TextBox ID="tbID" runat="server"></asp:TextBox>委托单号:<asp:TextBox ID="tbPID" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\QCC\R710801.rdlc"  DisplayName="配合比通知单">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="wz_sp_rpt_OpenCheck"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
                 <asp:ControlParameter ControlID="tbID" Name="CustID" PropertyName="Text" /> 
                 <asp:ControlParameter ControlID="tbPID" Name="CommitID" PropertyName="Text" />
           </SelectParameters>
       </asp:SqlDataSource>
