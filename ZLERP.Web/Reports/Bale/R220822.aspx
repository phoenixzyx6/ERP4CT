<%@ Page Title="材料购进发票统计表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Bale\R220822.rdlc" DisplayName="材料购进发票统计表">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ...
        SelectCommand="sp_rpt_StuffInInvoice" SelectCommandType="StoredProcedure" 
