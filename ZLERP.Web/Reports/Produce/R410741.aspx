<%@ Page Title="塌落度报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" 
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {            
            ...
            //string displayName = "塌落度报表"+DateTime.Now.ToString();

            //string browser = HttpContext.Current.Request.Browser.Browser.ToLower();
            //if (browser.IndexOf("firefox") == -1)
            //{
            //    displayName = HttpUtility.UrlEncode(displayName, System.Text.Encoding.UTF8);
            //}

            this.ReportViewer1.LocalReport.DisplayName = DateTime.Parse(tbBeginDate.Text).ToString("yyyy-MM-dd") + "至" + DateTime.Parse(tbEndDate.Text).ToString("yyyy-MM-dd") + "塌落度报表";
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Produce\R410741.rdlc"  DisplayName="塌落度报表">  
            <DataSources>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="sp_rpt_slump"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
    <SelectParameters>
