...
<script runat="server" language="c#">
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        //this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("Month1",Convert.ToInt32(this.tbDate.Text.Substring(4, 2)).ToString()));
        this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("Month1", this.tbDate.Text));
    ...
    private void RunProReport()
    {
        ...
        conn1.Open();
        System.Data.SqlClient.SqlCommand command1 = new System.Data.SqlClient.SqlCommand("sp_rpt_Stuffinfo_ZF_New", conn1);
        ...
        command1.Parameters.Add("@Month", System.Data.SqlDbType.VarChar, 60).Value = tbDate.Text.Trim();
   ...
   报表日期：<asp:TextBox ID="tbDate" Text=""  runat="server"></asp:TextBox>  
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_Stuffinfo_ZF_New"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
