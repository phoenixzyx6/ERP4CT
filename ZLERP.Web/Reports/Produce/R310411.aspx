<%@ Page Title="砼产品供应量统计二" Language="C#"   MasterPageFile="~/Reports/ReportsBase.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
   ...
   报表日期：<asp:TextBox ID="tbDate" Text=""  runat="server"></asp:TextBox>  <%--<asp:CheckBox ID="tbAll" Text="显示所有工程" runat="server" />--%>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana"  AsyncRendering="false" SizeToReportContent="true" ZoomMode="FullPage"
            Font-Size="9pt" InteractiveDeviceInfos="(集合)" WaitMessageFont-Names="Verdana" 
            WaitMessageFont-Size="12pt">
        <LocalReport ReportPath="Reports\Produce\R410812.rdlc"  DisplayName="砼产品供应量统计二">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_ConStrengthStatisticsT"  
