<%@ Page Title="砼强度月报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
   ...
   报表日期：<asp:TextBox ID="tbDate" Text="201203"  runat="server"></asp:TextBox>  
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Produce\R410703.rdlc"  DisplayName="砼强度月报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_constrength_monthly"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
