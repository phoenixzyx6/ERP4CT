<%@ Page Title="泵工方量统计" Language="C#"   MasterPageFile="~/Reports/ReportsBase.Master"
    ...
    <asp:RequiredFieldValidator
     ...
     <asp:Button ID="btnQuery" OnClick="btnQuery_Click" runat="server" Text="查询" /> <asp:Label ID="lblMsg" runat="server" ForeColor="Red" Text=""></asp:Label>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="100%" runat="server"
            ...
            <LocalReport ReportPath="Reports\Produce\R410807.rdlc" DisplayName="泵工方量统计">
                <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_PumpMan"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
