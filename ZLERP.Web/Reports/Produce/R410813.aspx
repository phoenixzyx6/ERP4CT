<%@ Page Title="合同结算调整明细统计报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master"
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("ContractName", ""));
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("BeginDate", tbBeginDate.Text));
        this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("EndDate", tbEndDate.Text));
        //this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("ContractName", tbContractName.Text));
        this.ReportViewer1.LocalReport.Refresh();
    }
</script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    合同名称：<asp:TextBox ID="tbContractName" Width="120" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Produce\R410813.rdlc" DisplayName="合同结算调整明细统计报表">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="sp_rpt_Jstz"
