<%@ Page Title="调度工方量统计" Language="C#"   MasterPageFile="~/Reports/ReportsBase.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
   ...
   起始时间：<asp:TextBox ID="tbBeginDate" Width="135" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="100%" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Produce\R410806.rdlc"  DisplayName="调度工方量统计">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_Signer"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
