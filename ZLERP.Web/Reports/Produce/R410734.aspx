<%@ Page Title="操作员方量统计报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master"
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            lblCondition.Text = "IsProduce = 1 AND ShipDocType = '0' AND Operator IS NOT NULL ";
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Produce\R410734.rdlc" DisplayName="操作员方量统计报表">
            <DataSources>
