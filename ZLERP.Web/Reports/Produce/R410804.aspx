...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
   ...
   报表日期：<asp:TextBox ID="tbDate" Text=""  runat="server"></asp:TextBox>  
    ...
    <div id="mainPanel" style="border-left:1px solid scrollbar; height: 600px;">
    <rsweb:ReportViewer ID="ReportViewer1" style="width:100%;height:100%;" 
            runat="server" Font-Names="Verdana" 
            Font-Size="9pt" InteractiveDeviceInfos="(集合)" WaitMessageFont-Names="Verdana" 
            WaitMessageFont-Size="12pt" AsyncRendering="False" Height="" 
            ZoomMode="FullPage">
