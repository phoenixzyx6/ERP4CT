<%@ Page Title="辅料发出汇总表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="100%" runat="server"
        ...
        <LocalReport ReportPath="Reports\Goods\R230903.rdlc" DisplayName="物资入库查询">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ...
        SelectCommand="sp_rpt_GoodOut" SelectCommandType="StoredProcedure" 
