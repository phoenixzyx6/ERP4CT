<%@ Page Title="物资进耗存统计报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Goods\R230901.rdlc" DisplayName="物资进耗存统计报表">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ...
        SelectCommand="sp_rpt_GoodsInfo_Detail" SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False">
