<%@ Page Title="生产销售累计表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Sales\R310402.rdlc"  DisplayName="生产销售累计表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server"   
           ...
           SelectCommand="sp_rpt_produce_sales_summary"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters>  
