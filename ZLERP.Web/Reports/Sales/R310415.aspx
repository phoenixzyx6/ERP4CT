<%@ Page Title="应收账款表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="100%" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Sales\R310415.rdlc"  DisplayName="应收账款表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server"   
           ...
           SelectCommand="sp_rpt_new_ContractPay"  SelectCommandType="StoredProcedure" 
