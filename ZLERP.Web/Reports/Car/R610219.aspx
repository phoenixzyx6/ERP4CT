<%@ Page Title="车辆运行情况统计表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<script runat="server" language="c#">
    ...
    private void RunProReport()
    {
        ...
        conn1.Open();
        System.Data.SqlClient.SqlCommand command1 = new System.Data.SqlClient.SqlCommand("sp_rpt_CarRunSituation", conn1);
        ...
        //为报表浏览器指定报表文件
        this.ReportViewer1.LocalReport.ReportEmbeddedResource = @"Reports\Car\R610219.rdlc";
        this.ReportViewer1.LocalReport.ReportPath = @"Reports\Car\R610219.rdlc";
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Car\R610219.rdlc"  DisplayName="车辆运行情况统计表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_CarRunSituation"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters>
