<%@ Page Title="应付账款统计表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<script runat="server" language="c#">
    ...
    protected void ReportViewer1_Drillthrough(object sender, DrillthroughEventArgs e)
    {
        ...
        if (detailDataSource.SelectParameters.Count == 3)
        {
            detailDataSource.SelectParameters.Remove(detailDataSource.SelectParameters["SupplyID"]);
        ...
        detailDataSource.SelectParameters.Add("SupplyID", rpt.GetParameters()["SupplyID"].Values.FirstOrDefault());

        rpt.DataSources.Add(new ReportDataSource("DataSet1", "detailDataSource"));
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
 ...
 <asp:Button ID="btnQuery" runat="server" OnClick="btnQuery_Click" Text="查询" />
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
            ...
            WaitMessageFont-Names="Verdana" ondrillthrough="ReportViewer1_Drillthrough"
            WaitMessageFont-Size="12pt" SizeToReportContent="True">
        <LocalReport ReportPath="Reports\Finance\R020303.rdlc"  DisplayName="应付账款统计表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_ap_summary"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
          <SelectParameters>
       ...
       <asp:SqlDataSource ID="detailDataSource" runat="server" 
           ConnectionString="<%$ ConnectionStrings:ZLERP %>" 
           ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" 
           SelectCommand="sp_rpt_ap_detail"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
          <SelectParameters>
            <asp:ControlParameter ControlID="tbBeginDate" Name="BeginDate" PropertyName="Text" /> 
            <asp:ControlParameter ControlID="tbEndDate" Name="EndDate" PropertyName="Text" />
