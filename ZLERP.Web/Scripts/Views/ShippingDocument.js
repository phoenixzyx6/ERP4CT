...
function shippingDocInit(opts) {
    ...
    var shippDocGrid = new MyGrid({
        ...
        //, { label: '车号', name: 'CarID', index: 'CarID', width: 50, align: 'right', searchoptions: { sopt: ['eq']} }
               , { label: "车号", name: "CarID", index: "CarID", width: 60, editable: true, formatter: dicCodeFmt, unformat: dicCodeUnFmt, formatoptions: { parentId: "ContractPayType" }, stype: "select", searchoptions: { value: getCarNoStr() }, edittype: 'select', editoptions: { value: getCarNoStr()} }
                ...
                , { label: '混凝土方量', name: 'BetonCount', index: 'BetonCount', width: 60, align: 'right', search: false, editable: true }
                , { label: '砂浆方量', name: 'SlurryCount', index: 'SlurryCount', width: 55, align: 'right', search: false, editable: true }
                , { label: '调度方量', name: 'SendCube', index: 'SendCube', width: 55, align: 'right', editable: true }
                , { label: '出票方量', name: 'ParCube', index: 'ParCube', width: 55, align: 'right', search: false, editable: true }
                , { label: '上车余料', name: 'RemainCube', index: 'RemainCube', width: 55, align: 'right', search: false }
                , { label: '运输方量', name: 'ShippingCube', index: 'ShippingCube', width: 55, align: 'right', search: false, editable: true }
                , { label: '签收方量', name: 'SignInCube', index: 'SignInCube', width: 55, align: 'right', editable: true }
                , { label: '报废方量', name: 'ScrapCube', index: 'ScrapCube', width: 55, align: 'right', search: false, editable: true }
                , { label: '本车余料', name: 'TransferCube', index: 'TransferCube', width: 55, align: 'right', search: false, editable: true }
                , { label: '其他方量2', name: 'XuCube', index: 'XuCube', width: 60, align: 'right', search: false, editable: true }
                , { label: '其他方量', name: 'OtherCube', index: 'OtherCube', width: 55, align: 'right', search: false, hidden: true, editable: true }
        ...
        // , { label: '运费', name: 'SumPrice', index: 'SumPrice' }
                ...
                , { label: '小票票号', name: 'TicketNO', index: 'TicketNO', search: false, width: 55, editable: true }
                ...
                , { label: '是否超时', name: 'IsOverTime', index: 'IsOverTime', align: 'center', width: 60, formatter: booleanFmt, unformat: booleanUnFmt, formatterStyle: { '0': '未超时', '1': '超时' }, stype: 'select', searchoptions: { value: booleanIsOverTimeSearchValues() }, editable: true, edittype: 'select', editoptions: { value: booleanIsOverTimeSelectValues()} }
    ...
    function getCarNoStr() {
        //动态生成select内容
        var requestURL = "/ShippingDocument.mvc/getCarNoList";
        var postParams = { };
        var str = "";
    ...
    function getPumpStr() {
        //动态生成select内容
        var requestURL = "/ShippingDocument.mvc/getPumpList";
        var postParams = {};
        var str = "";
