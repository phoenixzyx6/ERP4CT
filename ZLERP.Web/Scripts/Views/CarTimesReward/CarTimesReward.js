...
function cartimesrewardIndexInit(storeUrl) {
    ...
    var MyJqGridMain = new MyGrid({
        ...
        //, width: '100%'
            ...
            , buttons: buttons0
            , height: gGridHeight
		    , storeURL: "/CarTimesRewardMain.mvc/Find"
		    , sortByField: 'ID'
            , sortOrder: "ASC"
		    , primaryKey: 'ID'
            , dialogWidth: 300
    ...
    MyJqGridMain.addListeners('rowclick', function (id, record, selBool) {
        myJqGrid.refreshGrid("CarTimesRewardMainId='" + id + "'");
    });
    ...
    var myJqGrid = new MyGrid({
        renderTo: 'MyJqGrid'
            ...
            , groupField: 'DriverClassType'
             , editSaveUrl: "/CarTimesReward.mvc/Update"
		    , initArray: [
                { label: 'ID', name: 'ID', index: 'ID', hidden: true }
                , { label: '主表编号', name: 'CarTimesRewardMainId', index: 'CarTimesRewardMainId', editable: true, editrules: { required: true }, hidden: true }
                , { label: '班次类型', name: 'DriverClassType', index: 'DriverClassType', width: 80, formatter: dicCodeFmt, unformat: dicCodeUnFmt, formatoptions: { parentId: "DriverClassType" }, stype: "select", searchoptions: { value: dicToolbarSearchValues("DriverClassType") } }
                , { label: '开始次数', name: 'StartTimes', index: 'StartTimes', formatter: 'text', width: 120, hidden: false }
                , { label: '结束次数', name: 'EndTimes', index: 'EndTimes', formatter: 'text', width: 120, hidden: false }
                ...
                handleAdd: function (btn) {
                    ...
                    myJqGrid.handleAdd({
                        ...
                        afterFormLoaded: function () {
                            ...
                            $("#CarTimesRewardMainId").val(selectrecord.ID);
                        }
                    });
                },
                handleEdit: function (btn) {
